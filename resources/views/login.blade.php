@extends('layout')
@section('title', '4in1 Telecom || Login')
                                ...
                                <div class="registered-customers">
                                    ...
                                    <form action="#">
                                        <div class="login-account p-30 box-shadow">
                                            ...
                                            <input type="text" name="name" required placeholder="Email Address">
                                    ...
                                    <form action="#">
                                        ...
                                        <div class="login-account p-30 box-shadow">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="text"  required placeholder="Phone here...">
                                                </div>
                                            </div>
                                            <input type="text"  required placeholder="Company neme here...">
