                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2 col-md-3 col-sm-4">
                            <div class="single-footer">
                                ...
                                <ul class="footer-menu">
                                    <li>
                                        <a href="{{ url('/') }}"><i class="zmdi zmdi-circle"></i><span>My Account</span></a>
                                    </li>
                                    <li>
                                        <a href="{{ url('/') }}"><i class="zmdi zmdi-circle"></i><span>My Wishlist</span></a>
                                    </li>
                                    <li>
                                        <a href="{{ url('/') }}"><i class="zmdi zmdi-circle"></i><span>My Cart</span></a>
                                    </li>
                                    <li>
                                        <a href="{{ url('/') }}"><i class="zmdi zmdi-circle"></i><span>Sign In</span></a>
                                    </li>
                                    <li>
                                        <a href="{{ url('/') }}"><i class="zmdi zmdi-circle"></i><span>Registration</span></a>
                                    </li>
                                    <li>
                                        <a href="{{ url('/') }}"><i class="zmdi zmdi-circle"></i><span>Check out</span></a>
                                    </li>
                                    <li>
                                        <a href="{{ url('/') }}"><i class="zmdi zmdi-circle"></i><span>Oder Complete</span></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="single-footer">
                                ...
                                <div class="footer-message">
                                    <form action="#" method="#">
                                        ...
                                        <textarea class="height-80" name="message" required placeholder="Your messege here..."></textarea>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-xs-12">
                            <div class="copyright-text">
                                <p>&copy; <a href="https://freethemescloud.com/" target="_blank">Four In One Telecommunications</a> 2020. All Rights Reserved.</p>
                            </div>
                        </div>
                        <div class="col-sm-6 col-xs-12">
